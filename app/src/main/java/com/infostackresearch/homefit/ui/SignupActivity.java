...
public class SignupActivity extends AppCompatActivity {
    EditText ed_username, ed_mobilenumber, ed_email, ed_password, ed_confpassword;
    Button btn_signup;
            ...
            public void onClick(View view) {
                if (isValid()) {
                    if (networkConnectivity.isOnline()) {
                        ...
                        progressDialog.show();
                        doSignUP(ed_username.getText().toString(), ed_mobilenumber.getText().toString(), ed_email.getText().toString(), ed_password.getText().toString());
                    } else {
    ...
    private boolean isValid() {
        ...
        if (!ed_mobilenumber.getText().toString().isEmpty() && ed_mobilenumber.getText().toString().length() == 10) {
            validFlag = true;
        } else {
